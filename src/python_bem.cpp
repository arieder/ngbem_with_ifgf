...
PYBIND11_MODULE(_ngbem, m)
{
  ...
  m.def("SingleLayerPotentialOperator", [](shared_ptr<FESpace> space, int intorder, int leafsize, double eta, double eps,
                                           string method, bool testhmatrix,int expansion_order, int n_elements) -> shared_ptr<IntegralOperator<>>
  {
                                                    ...
                                                    string method, bool testhmatrix, int expansion_order, int n_elements, bool eval_nearfield) -> shared_ptr<IntegralOperator<Complex>>
  {
	...
	py::arg("method")="aca", py::arg("testhmatrix")=false,  py::arg("expansion_order")=8,py::arg("n_elements")=1, py::arg("eval_nearfield")=false);
